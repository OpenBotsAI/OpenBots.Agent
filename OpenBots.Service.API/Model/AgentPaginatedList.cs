...
namespace OpenBots.Service.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AgentPaginatedList : IEquatable<AgentPaginatedList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentPaginatedList" /> class.
        /// </summary>
        ...
        public AgentPaginatedList(int? pageNumber = default(int?), int? pageSize = default(int?), int? totalCount = default(int?), List<Agent> items = default(List<Agent>), int? completed = default(int?), int? started = default(int?), int? impediments = default(int?), Guid? parentId = default(Guid?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AgentPaginatedList {\n");
        ...
        {
            return this.Equals(input as AgentPaginatedList);
        }

        /// <summary>
        /// Returns true if AgentPaginatedList instances are equal
        /// </summary>
        /// <param name="input">Instance of AgentPaginatedList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AgentPaginatedList input)
        {
            if (input == null)
                return false;
