...
namespace IO.Swagger.Model
{
        ...
        public partial class Body4 :  IEquatable<Body4>, IValidatableObject
    {
        ...
        public Body4(string contentType = default(string), string contentDisposition = default(string), Dictionary<string, List<string>> headers = default(Dictionary<string, List<string>>), long? length = default(long?), string name = default(string), string fileName = default(string))
        {
