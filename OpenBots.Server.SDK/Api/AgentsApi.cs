...
namespace OpenBots.Server.SDK.Api
{
        ...
        public partial class AgentsApi : IAgentsApi
    {
        ...
        public ApiResponse< ConnectedViewModel > ApiVapiVersionAgentsAgentIDConnectPatchWithHttpInfo (string agentID, string apiVersion, string organizationId, ConnectAgentViewModel body = null)
        {
            ...
            if (body?.MachineName != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "MachineName", body?.MachineName)); // query parameter
            if (body?.MacAddresses != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "MacAddresses", body?.MacAddresses)); // query parameter
